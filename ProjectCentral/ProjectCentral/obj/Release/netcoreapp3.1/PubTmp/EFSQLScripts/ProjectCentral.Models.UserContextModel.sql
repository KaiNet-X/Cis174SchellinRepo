...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200610210023_Users2')
BEGIN
    CREATE TABLE [Roles] (
...
BEGIN
    ...
    VALUES (CAST(1 AS bigint), N'Admin', 1, N'Admin');
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'UserID', N'Password', N'RoleID', N'UserName') AND [object_id] = OBJECT_ID(N'[Users]'))
...
BEGIN
    ...
    VALUES (N'20200610210023_Users2', N'3.1.4');
END;
