...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200619220832_mm')
BEGIN
    CREATE TABLE [Genres] (
...
BEGIN
    ...
    VALUES (N'20200619220832_mm', N'3.1.4');
END;

GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200629165613_m1')
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20200629165613_m1', N'3.1.4');
END;
